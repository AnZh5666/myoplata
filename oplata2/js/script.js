async function getData() {
    let response = await fetch('https://648a8b9517f1536d65e93b38.mockapi.io/oplata', {
        headers: {
...
const createStringTable = (item, index) => {
    ...
    return `
            <tr class="worked">
                ...
                <td class="td-del"><button class="btn-del" onclick="deleteObj(${index},${item.id})">&#10145</button></td>
            </tr>
    `
}
